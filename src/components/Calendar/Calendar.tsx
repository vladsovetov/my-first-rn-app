    ...
    <ScrollView className="flex-1 bg-white ">
      <View className="p-4">
        ...
        <View className="flex-row mb-4">
          <Pressable
            className="flex-1 h-10 bg-blue-500 rounded-l-lg justify-center items-center"
            onPress={() => navigateMonthDate(-1)}>
            <Text className="text-white font-medium">Prev Month</Text>
          </Pressable>
          <Pressable
            className="flex-1 h-10 bg-blue-500 rounded-r-lg justify-center items-center border-l border-blue-400"
            onPress={() => navigateMonthDate(1)}>
            <Text className="text-white font-medium">Next Month</Text>
          </Pressable>
        </View>

        <View className="flex-row bg-blue-300 rounded-t-lg">
          {weekDays.map(day => (
            <View
              key={day}
